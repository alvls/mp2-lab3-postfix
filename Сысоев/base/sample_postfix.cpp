...
int main()
{
	...
	do 
	{
		try
		{
			...
			cout << "Если вы хотите ввести дробное значение, отделяйте дробную часть запятой\n";
			cout << "Не вводите минус вначале. Если вначале нужен отрицательный операнд, объявите его переменной\n";
			c = getchar();
			while (c != '\n')
			{
